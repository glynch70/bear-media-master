...
export function LocalBusinessSchema() {
  const schema = {
    ...
    description: 'Content days, website design, photography and video for businesses across Edinburgh and the Lothians.',
    url: siteUrl,
...
export function OrganizationSchema() {
  const schema = {
    ...
    description: 'Content days, website builds, photography and video for businesses across Edinburgh and the Lothians.',
    foundingDate: '2024',
    founder: {
      '@type': 'Person',
      '@id': personId,
...
export function ProfessionalServiceSchema() {
  const schema = {
    ...
    telephone: '+447879011860',
    email: 'info@bear-media.com',
    description: 'Content days, website design, photography and video for businesses in Edinburgh and the Lothians.',
    address: {
      '@type': 'PostalAddress',
      addressLocality: 'Broxburn',
      addressRegion: 'West Lothian',
    ...
    areaServed: ['Edinburgh', 'West Lothian', 'East Lothian', 'Midlothian', 'Fife', 'Scotland'],
    founder: {
      '@type': 'Person',
      '@id': personId,
      name: 'Garry Lynch',
